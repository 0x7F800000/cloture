...
void M_Menu_Transfusion_Episode_f ();
void M_Menu_Transfusion_Skill_f ();
void M_Menu_Load_f ();
void M_Menu_Save_f ();
void M_Menu_MultiPlayer_f ();
void M_Menu_Setup_f ();
void M_Menu_Options_f ();
void M_Menu_Options_Effects_f ();
void M_Menu_Options_Graphics_f ();
void M_Menu_Options_ColorControl_f ();
void M_Menu_Keys_f ();
void M_Menu_Reset_f ();
void M_Menu_Video_f ();
void M_Menu_Help_f ();
...
void M_Menu_ModList_f ();

static void M_Main_Draw ();
static void M_SinglePlayer_Draw ();
static void M_Transfusion_Episode_Draw ();
static void M_Transfusion_Skill_Draw ();
...
static void M_Options_Effects_Draw ();
static void M_Options_Graphics_Draw ();
static void M_Options_ColorControl_Draw ();
static void M_Keys_Draw ();
static void M_Reset_Draw ();
static void M_Video_Draw ();
static void M_Help_Draw ();
static void M_Credits_Draw ();
static void M_Quit_Draw ();
static void M_LanConfig_Draw ();
static void M_GameOptions_Draw ();
static void M_ServerList_Draw ();
static void M_ModList_Draw ();
...
static void ModList_RebuildList()
{
	int i,j;
	stringlist_t list;

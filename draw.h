...
float DrawQ_String(float x, float y, const char *text, size_t maxlen, float scalex, float scaley, float basered, float basegreen, float baseblue, float basealpha, int flags, int *outcolor, bool ignorecolorcodes, const dp_font_t *fnt);
float DrawQ_String_Scale(float x, float y, const char *text, size_t maxlen, float sizex, float sizey, float scalex, float scaley, float basered, float basegreen, float baseblue, float basealpha, int flags, int *outcolor, bool ignorecolorcodes, const dp_font_t *fnt);
...
void DrawQ_ProcessDrawFlag(int flags, bool alpha); // sets GL_DepthMask and GL_BlendFunc

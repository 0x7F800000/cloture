...
#define Vector2Clear(a) ((a)[0]=(a)[1]=.0f)
...
#define Vector2Normalize2(v,dest) {float ilength = (float) sqrtf(DotProduct2((v),(v)));if (ilength) ilength = 1.0f / ilength;dest[0] = (v)[0] * ilength;dest[1] = (v)[1] * ilength;}

#define DotProduct4(a,b) ((a)[0]*(b)[0]+(a)[1]*(b)[1]+(a)[2]*(b)[2]+(a)[3]*(b)[3])
#define Vector4Clear(a) ((a)[0]=(a)[1]=(a)[2]=(a)[3]=.0f)
...
#define VectorClear(a) ((a)[0]=(a)[1]=(a)[2]=.0f)
...
#define VectorDistance(a, b) (sqrtf(VectorDistance2(a,b)))
...
+ ((p)[2] - (a)[2]) * (((a)[0] - (b)[0]) * ((c)[1] - (b)[1]) - ((a)[1] - (b)[1]) * ((c)[0] - (b)[0])) > .0f)
...
#define VectorCheeseRandom(v) do{(v)[0] = lhcheeserandom(-1, 1);(v)[1] = lhcheeserandom(-1, 1);(v)[2] = lhcheeserandom(-1, 1);}while(DotProduct(v, v) > 1.0f)

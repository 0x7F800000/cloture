...
//using r_shadow_bouncegrid_settings_t = r_shadow_bouncegrid_settings_s;
...
{
	if (r_shadow_bouncegridtexture) R_FreeTexture(r_shadow_bouncegridtexture);r_shadow_bouncegridtexture = nullptr;

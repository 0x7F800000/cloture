...
static unsigned int			(*qpng_access_version_number)		(); // FIXME is this return type right? It is a png_uint_32 in libpng
...
// Handle for PNG DLL
dllhandle_t png_dll = nullptr;
dllhandle_t png14_dll = nullptr;
...
bool PNG_SaveImage_preflipped (const char *filename, int width, int height, bool has_alpha, unsigned char *data)
{
	...
	if(!pnginfo)
	{
		 qpng_destroy_write_struct(&png, nullptr);
		 return false;
	}

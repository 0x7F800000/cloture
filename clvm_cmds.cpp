...
static void VM_CL_precache_model (prvm_prog_t *prog)
{
	...
	m = Mod_ForName(name, false, false, name[0] == '*' ? cl.model_name[1] : nullptr);
	if(m && m->loaded)
	{
		for (i = 0;i < MAX_MODELS;i++)
		{
...
static void VM_CL_droptofloor (prvm_prog_t *prog)
{
	...
	trace = CL_TraceBox(start, mins, maxs, end, MOVE_NORMAL, ent, CL_GenericHitSuperContentsMask(ent), collision_extendmovelength.value, true, true, nullptr, true);
...
static void VM_CL_registercmd (prvm_prog_t *prog)
{
	...
	if(!Cmd_Exists(PRVM_G_STRING(OFS_PARM0)))
	{
		...
		Cmd_AddCommand(t, nullptr, "console command created by QuakeC");
	}
	else
		Cmd_AddCommand(PRVM_G_STRING(OFS_PARM0), nullptr, "console command created by QuakeC");
...
nullptr,							// #0 nullptr function (not callable) (QUAKE)
...
nullptr,							// #5 void(entity e, vector min, vector max) setabssize (QUAKE)
...
nullptr,							// #17 entity() checkclient (QUAKE)
...
nullptr,							// #21 void(entity client, string s, ...) stuffcmd (QUAKE)
VM_CL_findradius,				// #22 entity(vector org, float rad) findradius (QUAKE)
nullptr,							// #23 void(string s, ...) bprint (QUAKE)
nullptr,							// #24 void(entity client, string s, ...) sprint (QUAKE)
...
nullptr,							// #44 vector(entity e, float speed) aim (QUAKE)
...
nullptr,							// #52 void(float to, float f) WriteByte (QUAKE)
nullptr,							// #53 void(float to, float f) WriteChar (QUAKE)
nullptr,							// #54 void(float to, float f) WriteShort (QUAKE)
nullptr,							// #55 void(float to, float f) WriteLong (QUAKE)
nullptr,							// #56 void(float to, float f) WriteCoord (QUAKE)
nullptr,							// #57 void(float to, float f) WriteAngle (QUAKE)
nullptr,							// #58 void(float to, string s) WriteString (QUAKE)
nullptr,							// #59 (QUAKE)
...
nullptr,							// #78 void(entity e) setspawnparms (QUAKE)
nullptr,							// #79 void(entity killer, entity killee) logfrag (QUAKEWORLD)
nullptr,							// #80 string(entity e, string keyname) infokey (QUAKEWORLD)
VM_stof,						// #81 float(string s) stof (FRIK_FILE)
nullptr,							// #82 void(vector where, float set) multicast (QUAKEWORLD)
nullptr,							// #83 (QUAKE)
nullptr,							// #84 (QUAKE)
nullptr,							// #85 (QUAKE)
nullptr,							// #86 (QUAKE)
...
nullptr,							// #231
nullptr,							// #232 void(float index, float type, .void field) SV_AddStat (EXT_CSQC)
nullptr,							// #233
nullptr,							// #234
nullptr,							// #235
nullptr,							// #236
...
VM_drawresetcliparea,			// #325 void() drawresetcliparea
...
nullptr,							// #401 void(entity ent, float colors) setcolor (DP_QC_SETCOLOR)
...
nullptr,							// #440 void(entity e, string s) clientcommand (KRIMZON_SV_PARSECLIENTCOMMAND)
...
nullptr,							// #453 void(entity clent) dropclient (DP_SV_DROPCLIENT)
nullptr,							// #454 entity() spawnclient (DP_SV_BOTCLIENT)
nullptr,							// #455 float(entity clent) clienttype (DP_SV_BOTCLIENT)
nullptr,							// #456 void(float to, string s) WriteUnterminatedString (DP_SV_WRITEUNTERMINATEDSTRING)
...
nullptr,							// #470 void(float index, float type, .void field) SV_AddStat (EXT_CSQC)
...
nullptr,							// #622
nullptr,							// #623
VM_CL_getextresponse,			// #624 string getextresponse()
nullptr,							// #625
nullptr,							// #626
...
VM_getbindmaps,						// #631 vector() getbindmap

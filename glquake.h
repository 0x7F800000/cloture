...
#endif //#ifndef GL_PROGRAM_OBJECT
...
#endif //#ifndef GL_FRAGMENT_SHADER

// GL 2.0 shading language 100
#ifndef GL_SHADING_LANGUAGE_VERSION
	#define GL_SHADING_LANGUAGE_VERSION				0x8B8C
#endif //#ifndef GL_SHADING_LANGUAGE_VERSION
...
#endif //#ifndef GL_COMPRESSED_RGB_ARB
...
#endif //#ifndef GL_COMPRESSED_RGB_S3TC_DXT1_EXT
...
#endif //#ifndef GL_QUERY_BUFFER_ARB
...
#ifdef DEBUGGL
	#ifdef USE_GLES2
		#define CHECKGLERROR {if (unlikely(gl_paranoid.integer)){if (unlikely(gl_printcheckerror.integer)) Con_Printf("CHECKGLERROR at %s:%d\n", __FILE__, __LINE__);errornumber = glGetError();if (unlikely(errornumber)) GL_PrintError(errornumber, __FILE__, __LINE__);}}
	#else
		#define CHECKGLERROR {if (unlikely(gl_paranoid.integer)){if (unlikely(gl_printcheckerror.integer)) Con_Printf("CHECKGLERROR at %s:%d\n", __FILE__, __LINE__);errornumber = qglGetError ? qglGetError() : 0;if (unlikely(errornumber)) GL_PrintError(errornumber, __FILE__, __LINE__);}}

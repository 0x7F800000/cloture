...
CFLAGS_MAKEDEP?=-x c++ -ggdb -msse3 -m3dnow $(CLOTURE_OPT) -DCONFIG_MENU -DCONFIG_CD $(EXTRA_DEFINES) $(EXTRA_INCLUDES) -MMD -fno-rtti -fomit-frame-pointer -fms-extensions $(CXXSTANDARD) -Wfatal-errors -w -fpermissive
CFLAGS_NOSYSHEADERS=
ifeq ($(CXX), icc)

...
CFLAGS_MAKEDEP?=-x c++ -mmmx -msse3 -msse4a -m3dnow $(CLOTURE_OPT) -DCONFIG_MENU -DCONFIG_CD $(EXTRA_DEFINES) $(EXTRA_INCLUDES) -MMD -fomit-frame-pointer -fms-extensions $(CXXSTANDARD) -Wfatal-errors -w -fpermissive
CFLAGS_NOSYSHEADERS=
ifeq ($(CXX), icc)

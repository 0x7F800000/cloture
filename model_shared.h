...
typedef struct model_brush_s
{
	...
	bool (*TraceLineOfSight)(struct model_s *model, const vec3_t start, const vec3_t end);
...
void Mod_FreeQ3Shaders();
void Mod_LoadQ3Shaders();

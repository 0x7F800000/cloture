...
using serverlist_entry_s = serverlist_entry_t;
...
extern "C" serverlist_mask_t serverlist_andmasks[SERVERLIST_ANDMASKCOUNT];
extern "C" serverlist_mask_t serverlist_ormasks[SERVERLIST_ORMASKCOUNT];

extern "C" serverlist_infofield_t serverlist_sortbyfield;
extern "C" int serverlist_sortflags; // not using the enum, as it is a bitmask

#if SERVERLIST_TOTALSIZE > 65536
#error too many servers, change type of index array
#endif
extern "C" int serverlist_viewcount;
extern "C" unsigned short serverlist_viewlist[SERVERLIST_VIEWLISTSIZE];

extern "C" int serverlist_cachecount;
extern "C" serverlist_entry_t *serverlist_cache;
extern "C" const serverlist_entry_t *serverlist_callbackentry;

extern "C" bool serverlist_consoleoutput;
...
void NetConn_Listen(bool state);

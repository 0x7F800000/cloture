...
typedef struct viddef_s
{
	...
	bool sRGBcapable2D; // whether 2D rendering can be sRGB corrected (renderpath, v_hwgamma)
	bool sRGBcapable3D; // whether 3D rendering can be sRGB corrected (renderpath, v_hwgamma)
...
bool VID_HasScreenKeyboardSupport();
void VID_ShowKeyboard(bool show);
bool VID_ShowingKeyboard();

...
//	CHECKGLERROR
	...
	R_Viewport_InitOrtho(&viewport, reinterpret_cast<const matrix4x4_t*>(&identitymatrix), 0, 0, vid.width, vid.height, 0, 0, vid_conwidth.integer, vid_conheight.integer, -10, 100, NULL);
